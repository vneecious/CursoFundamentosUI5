		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Benefícios",
									"targetURL": "#brgovbndeszhrbeneficio-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brgovbndeszhrbeneficio-display": {
								"semanticObject": "brgovbndeszhrbeneficio",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.gov.bndes.zhrbeneficio",
									"url": sap.ui.require.toUrl("br/gov/bndes/zhrbeneficio")
								}
							}
						}
					}
